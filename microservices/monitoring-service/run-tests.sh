...
# Monitoring Service Test Runner
# This script runs all tests for the Monitoring Service

set -e

echo "🧪 Starting Monitoring Service Tests..."
...
run_unit_tests() {
    ...
    export DB_NAME=statuspage_monitoring_test
...
# Main function
main() {
    print_status "Starting Monitoring Service Test Suite..."
