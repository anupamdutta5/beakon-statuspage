...
# Landing Page Service Test Runner
# This script runs all tests for the Landing Page Service

set -e

echo "🧪 Starting Landing Page Service Tests..."
...
run_unit_tests() {
    ...
    export DB_NAME=statuspage_landing_page_test
...
# Main function
main() {
    print_status "Starting Landing Page Service Test Suite..."
