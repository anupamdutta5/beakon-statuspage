...
# This script runs all tests for the Tenant Service

set -e

echo "🧪 Starting Tenant Service Tests..."
...
run_unit_tests() {
    ...
    export DB_NAME=statuspage_tenant_test
...
# Main function
main() {
    print_status "Starting Tenant Service Test Suite..."
