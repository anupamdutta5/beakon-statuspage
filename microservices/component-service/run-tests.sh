...
# Component Service Test Runner
# This script runs all tests for the Component Service

set -e

echo "🧪 Starting Component Service Tests..."
...
run_unit_tests() {
    ...
    export DB_NAME=statuspage_component_test
...
# Main function
main() {
    print_status "Starting Component Service Test Suite..."
