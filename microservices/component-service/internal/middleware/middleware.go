// Package middleware provides HTTP middleware for the Component Service.
package middleware
...
func CORS() gin.HandlerFunc {
	...
	config.AllowHeaders = []string{"Origin", "Content-Type", "Accept", "Authorization", "X-Requested-With", "X-Correlation-ID"}
