...
# This script runs all tests for the Payment Service
...
run_unit_tests() {
    ...
    export DB_NAME=statuspage_payment_test
    export STRIPE_SECRET_KEY=sk_test_123456789
    export STRIPE_PUBLIC_KEY=pk_test_123456789
...
# Main function
main() {
    print_status "Starting Payment Service Test Suite..."
