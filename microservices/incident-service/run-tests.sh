...
# Incident Service Test Runner
# This script runs all tests for the Incident Service

set -e

echo "🧪 Starting Incident Service Tests..."
...
run_unit_tests() {
    ...
    export DB_NAME=statuspage_incident_test
...
# Main function
main() {
    print_status "Starting Incident Service Test Suite..."
