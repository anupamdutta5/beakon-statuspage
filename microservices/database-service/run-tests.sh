...
# This script runs all tests for the Database Service

set -e

echo "🧪 Starting Database Service Tests..."
...
run_unit_tests() {
    ...
    export DB_NAME=statuspage_database_test
...
# Main function
main() {
    print_status "Starting Database Service Test Suite..."
