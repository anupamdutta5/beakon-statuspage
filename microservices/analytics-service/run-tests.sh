...
# This script runs all tests for the Analytics Service

set -e

echo "🧪 Starting Analytics Service Tests..."
...
run_unit_tests() {
    ...
    export DB_NAME=statuspage_analytics_test
...
# Main function
main() {
    print_status "Starting Analytics Service Test Suite..."
