...
type AnalyticsConfig struct {
	...
	AggregationInterval string   `yaml:"aggregation_interval"` // hourly, daily, weekly, monthly
	CacheEnabled        bool     `yaml:"cache_enabled"`
	CacheTTL            int      `yaml:"cache_ttl"`      // in seconds
	ExportFormats       []string `yaml:"export_formats"` // csv, json, excel
	MaxDataPoints       int      `yaml:"max_data_points"`
	RealTimeEnabled     bool     `yaml:"real_time_enabled"`
}
