...
# SaaS Admin Service Test Runner
# This script runs all tests for the SaaS Admin Service

set -e

echo "🧪 Starting SaaS Admin Service Tests..."
...
run_unit_tests() {
    ...
    export DB_NAME=statuspage_saas_admin_test
...
# Main function
main() {
    print_status "Starting SaaS Admin Service Test Suite..."
