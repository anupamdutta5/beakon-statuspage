...
# Branding Service Test Runner
# This script runs all tests for the Branding Service

set -e

echo "🧪 Starting Branding Service Tests..."
...
run_unit_tests() {
    ...
    export DB_NAME=statuspage_branding_test
...
# Main function
main() {
    print_status "Starting Branding Service Test Suite..."
