...
import (
	...
	"github.com/enterprise-status/statuspage-branding-service/internal/server"
	"github.com/enterprise-status/statuspage-branding-service/pkg/logger"
	"go.uber.org/zap"
)
...
func main() {
	...
	go func() {
		logger.Info("Branding Service starting...")
	...
	case <-shutdownCtx.Done():
		logger.Warn("Branding Service shutdown timeout")
	default:
		logger.Info("Branding Service stopped gracefully")
	}

	logger.Info("Branding Service exited")
}
