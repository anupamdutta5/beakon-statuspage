...
# Event Store Service Test Runner
# This script runs all tests for the Event Store Service

set -e

echo "🧪 Starting Event Store Service Tests..."
...
run_unit_tests() {
    ...
    export DB_NAME=statuspage_event_store_test
...
run_integration_tests() {
    ...
    docker-compose -f docker-compose.test.yml up -d postgres redis zookeeper kafka
...
# Main function
main() {
    print_status "Starting Event Store Service Test Suite..."
